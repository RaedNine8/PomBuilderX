...
/**
 * class for  automating the setup of a CI/CD pipeline
 * with multi-architecture Docker images, using CircleCI and GitHub Actions.
 */
...
public class PipelineCommands {
				...
				jobs:
				  arm64-native:
				    ...
				    steps:
				      ...
				      - docker/push:
				          image: username/$CIRCLE_PROJECT_REPONAME
    ...
    private String githubWorkflowFile() {
        return """
				...
				env:
				  IMAGE_NAME: your_username/${GITHUB_REPOSITORY#*/}
